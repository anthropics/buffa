...
fn test_json_oneof_round_trip() {
    ...
    let msg = WithOneof {
        value: Some(crate::json_types::buffa_::oneof::with_oneof::Value::Text(
            "hello".into(),
        )),
        ..Default::default()
    };
...
fn test_json_oneof_all_scalar_types_round_trip() {
    ...
    use crate::json_types::buffa_::oneof::with_oneof_types::Kind as KindOneof;
...
fn test_json_mixed_oneof_and_fields_round_trip() {
    use crate::json_types::buffa_::oneof::mixed_oneof_and_fields::Choice as ChoiceOneof;
...
fn test_json_mixed_value_field_null_forwarding() {
    ...
    use crate::json_types::MixedOneofAndFields;
    use buffa_types::google::protobuf::buffa_::oneof::value::Kind as KindOneof;
    use buffa_types::google::protobuf::NullValue;
