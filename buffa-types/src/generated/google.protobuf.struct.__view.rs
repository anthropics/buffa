...
::buffa::unsafe_impl_view_lifetime_parametric!(StructView);
...
::buffa::unsafe_impl_view_lifetime_parametric!(ValueView);
...
::buffa::unsafe_impl_view_lifetime_parametric!(ListValueView);
