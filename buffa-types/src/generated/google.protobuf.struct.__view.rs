// @generated by protoc-gen-buffa. DO NOT EDIT. (view:: module contents)
...
pub struct ValueView<'a> {
    pub kind: ::core::option::Option<oneofs::value::Kind<'a>>,
    pub __buffa_unknown_fields: ::buffa::UnknownFieldsView<'a>,
}
impl<'a> ValueView<'a> {
    /// Decode from `buf`, enforcing a recursion depth limit for nested messages.
        ...
        while !cur.is_empty() {
            ...
            match tag.field_number() {
                ...
                5u32 => {
                    ...
                    if let Some(oneofs::value::Kind::StructValue(ref mut existing)) = view
                        .kind
                    {
                ...
                6u32 => {
                    ...
                    let sub = ::buffa::types::borrow_bytes(&mut cur)?;
                    if let Some(oneofs::value::Kind::ListValue(ref mut existing)) = view
                        .kind
                    {
                        existing._merge_into_view(sub, depth - 1)?;
                    } else {
    ...
    fn to_owned_message(&self) -> super::Value {
        ...
        super::Value {
            kind: self
                ...
                .as_ref()
                .map(|v| match v {
                    oneofs::value::Kind::NullValue(v) => {
                        super::oneofs::value::Kind::NullValue(*v)
                    }
                    oneofs::value::Kind::NumberValue(v) => {
                        super::oneofs::value::Kind::NumberValue(*v)
                    }
                    oneofs::value::Kind::StringValue(v) => {
                        super::oneofs::value::Kind::StringValue(v.to_string())
                    }
                    oneofs::value::Kind::BoolValue(v) => {
                        super::oneofs::value::Kind::BoolValue(*v)
                    }
                    oneofs::value::Kind::StructValue(v) => {
                        super::oneofs::value::Kind::StructValue(
                            ::buffa::alloc::boxed::Box::new(v.to_owned_message()),
                        )
                    }
                    oneofs::value::Kind::ListValue(v) => {
                        super::oneofs::value::Kind::ListValue(
                            ::buffa::alloc::boxed::Box::new(v.to_owned_message()),
                        )
                    }
                }),
